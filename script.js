...
const translations = {
  en: {
    ...
    ".button-primary":
      'See the menu <i class="fa-solid fa-arrow-down" aria-hidden="true"></i>',
    ".text-link":
      'Book your table <i class="fa-solid fa-arrow-right" aria-hidden="true"></i>',
    "#about .section-label": "01 / Our story",
    "#about h2": "Good food has<br><em>a bright side.</em>",
    "#about .intro-content p":
      "Bloom is your sunny corner for clean, colourful food and drinks made with care. Come for a quick refresh, stay for the good conversation.",
    "#about .intro-note span": "Clean food.<br>Fresh energy.",
    "#menu .section-label": "02 / From our kitchen",
    "#menu h2": "Bloom <em>menu</em>",
    ...
    "#reserve .reserve-copy > p":
      "Planning a breakfast, lunch, or just a good catch-up? We’ll have your table ready.",
    ...
    ".button-dark":
      'Send via WhatsApp <i class="fa-brands fa-whatsapp" aria-hidden="true"></i>',
  ...
  pt: {
    ...
    ".button-primary":
      'Ver o menu <i class="fa-solid fa-arrow-down" aria-hidden="true"></i>',
    ".text-link":
      'Reserve a sua mesa <i class="fa-solid fa-arrow-right" aria-hidden="true"></i>',
    "#about .section-label": "01 / A nossa história",
    "#about h2": "Comida boa tem<br><em>um lado luminoso.</em>",
    "#about .intro-content p":
      "A Bloom é o seu cantinho ensolarado para comida e bebidas frescas, coloridas e feitas com carinho. Venha refrescar-se e fique pela boa conversa.",
    "#about .intro-note span": "Comida fresca.<br>Energia boa.",
    "#menu .section-label": "02 / Da nossa cozinha",
    "#menu h2": "Menu <em>Bloom</em>",
    ...
    "#reserve .reserve-copy > p":
      "A planear um pequeno-almoço, almoço ou encontro? Teremos a sua mesa pronta.",
    "#reserve .reserve-contact small": "Ligue para reservas de grupos",
    'label[for="name"]': "O seu nome",
    'label[for="date"]': "Data",
    'label[for="time"]': "Hora",
    'label[for="guests"]': "Pessoas",
    'label[for="phone"]': "Telefone",
    ".button-dark":
      'Enviar pelo WhatsApp <i class="fa-brands fa-whatsapp" aria-hidden="true"></i>',
...
function applyLanguage(language) {
  ...
  document.querySelector("#time option").textContent =
    language === "pt" ? "Escolha" : "Choose";
  document.querySelector("#guests option").textContent =
    language === "pt" ? "Escolha" : "Choose";
  document.querySelector("#name").placeholder =
    language === "pt" ? "ex.: Amara Banda" : "e.g. Amara Banda";
  document.querySelector("#phone").placeholder =
    language === "pt" ? "O seu número" : "Your number";
  [...document.querySelectorAll("#guests option")]
    .slice(1)
    .forEach((option, index) => {
      const portugueseGuests = [
        "1 pessoa",
        "2 pessoas",
        "3 pessoas",
        "4+ pessoas",
      ...
      option.textContent =
        language === "pt"
          ? portugueseGuests[index]
          : `${index + 1}${index === 3 ? "+" : ""} ${index === 0 ? "guest" : "guests"}`;
    });
  languageToggle.querySelector("span").textContent =
    language === "pt" ? "EN" : "PT";
  languageToggle.setAttribute(
    "aria-label",
    language === "pt" ? "Switch to English" : "Switch to Portuguese",
  );
...
// Reservation form
const whatsappNumber = "258841566772";
...
reservationForm.addEventListener("submit", (event) => {
  ...
  const reservationMessage =
    currentLanguage === "pt"
      ? [
          "Olá Bloom Cafe, gostaria de pedir uma reserva.",
          `Nome: ${formData.get("name")}`,
          `Data: ${formData.get("date")}`,
          `Hora: ${formData.get("time")}`,
          `Pessoas: ${formData.get("guests")}`,
          `Telefone: ${formData.get("phone")}`,
        ].join("\n")
      : [
          "Hello Bloom Cafe, I would like to request a reservation.",
